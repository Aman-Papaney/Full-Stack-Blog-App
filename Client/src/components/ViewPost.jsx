			...
			<div className='main'>
				<div className='view-post '>
					<div className='view-post-title'>
						{postData.title}
						{loggedUserDetails !== null && loggedUserDetails.username === postData.author ? (
							<button className='edit-button' onClick={() => navTo(`edit/${postData._id}`)}>
								{
						...
						{loggedUserDetails !== null && loggedUserDetails.username === postData.author ? (
							<button className='edit-button' onClick={deletePost}>
								{
